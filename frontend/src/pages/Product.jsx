    ...
    <div className='border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100'>
      ...
      <div className='mt-20'>
        ...
        <div className="flex flex-col gap-4 px-6 py-6 text-sm text-gray-500">
          <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Animi voluptatum maxime porro placeat. Ea, commodi? Ullam tempora eius ipsum. Dolor.</p>
          <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Possimus rem id qui nostrum sit libero, soluta officiis?</p>
        </div>
      </div>
