      ...
      <div className="flex flex-col sm:grid grid-cols-[3fr_1fr_1fr] gap-14 my-10 mt-40 text-sm">
        ...
        <div>
          ...
          <p className='w-full md:w-2/3 text-gray-600'>
            CampusCart is a department-wise online bookstore for college students,
          ...
          <div className="flex gap-4 mt-4 text-xl text-gray-600">
            ...
            <a href="mailto:campuscart856@email.com"><FaEnvelope /></a>
          </div>
        </div>

        
        <div>
          <p className='text-xl font-medium mb-5'>CAMPUSCART</p>
          <ul className='flex flex-col gap-1 text-gray-600'>
            ...
            <li>
              <Link to='/collection' className='hover:text-gray-900'>Departments</Link>
            </li>
            <li>
        ...
        <div>
          ...
          <ul className='flex flex-col gap-1 text-gray-600'>
            <li>campuscart@gmail.com</li>
            <li>College Campus, Dept. of CSE</li>
          </ul>
          <Link
            to='/contact'
            className='mt-4 inline-flex w-fit items-center justify-center rounded-full border border-gray-900 px-5 py-2 text-xs font-semibold text-gray-900 hover:bg-gray-900 hover:text-white transition'
          >
            Contact
          </Link>
        </div>
